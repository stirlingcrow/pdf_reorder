from utils import see_data,extract_master_data, extract_subordinate_data, reorder_and_merge

def main():
    # File paths
    master_pdf = "data/Subordinate.pdf"
    #subordinate_pdf = "data/Subordinate.pdf"
    #output_pdf = "data/Output.pdf"
    
    # Extract data
    #print("Extracting data from Master PDF...")
    master_data = see_data(master_pdf)
